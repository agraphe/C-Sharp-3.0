...
namespace Example_21_5____Joining_results
{
    using System;
using System.Collections.Generic;
using System.Linq;
        ...
        static void Main(string[] args)
        {
            ...
            List<PurchaseOrder> orderList = new List<PurchaseOrder>
            {
                new PurchaseOrder { OrderNumber = 23483,
                                    ...
                                    Quantity = 57 },
                new PurchaseOrder { OrderNumber = 57284,
                                    Title = "Head First C#",
                                    Quantity = 42 },
                new PurchaseOrder { OrderNumber = 56389,
                                    Title = "Programming C# 3.0",
                                    Quantity = 12 },
                new PurchaseOrder { OrderNumber = 95639,
                                    Title = "C# 3.0 Cookbook",
                                    Quantity = 122 },
                new PurchaseOrder { OrderNumber = 57493,
                                    Title = "C# 3.0 in a Nutshell",
                                    Quantity = 43 },
                new PurchaseOrder { OrderNumber = 73558,
                                    Title = "Programming C# 3.0",
                                    Quantity = 99 },
                new PurchaseOrder { OrderNumber = 45385,
                                    Title = "C# 3.0 Cookbook",
                                    Quantity = 35 },
